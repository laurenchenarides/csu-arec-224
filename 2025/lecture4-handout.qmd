...
## Opportunity _____________

Opportunity _____________ is central to entrepreneurship and revolves around three key questions:  
...
- _____________ and _____________ environments alert entrepreneurs to opportunities.
- _____________ signal shifts in current paradigm (or thinking) of major population.
...
- _____________: Higher disposable incomes, dual wage-earner families, performance pressures\
...
:::: fragment
::: {.callout-note icon="false" title="*Definition:* _____________"}
_____________ exist in the gap between expectations and reality.  
...
## Entrepreneurial _____________ and _____________

- Creative thinking is blended with _____________ in a logical process.
- Entrepreneurs develop an ability to see, recognize, and create _____________ where others find only problems.
...
Some individuals act as **_____________**, improving and refining existing systems.  

Others operate as **_____________**, challenging assumptions and pushing for change.  
...
Count how many times you select **_____________** versus **_____________**.  
...
_____________ is a process that can be developed and improved. 

Some individuals have a greater aptitude for creativity than others.
$\rightarrow$ That's OK! 

Typical _____________ Process:\
...
## Phase 1: Background or _____________ Accumulation
...
- **_____________ _____________** is the process of studying consumer trends, supply chain shifts, policy changes, and competitor strategies.\  
...
## Phase 2: The _____________ Process
...
## Phase 3: The _____________ Experience
...
Recognizing _____________ and developing a _____________ perspective are both mental tools that entrepreneurs use to see opportunities others overlook.
...
- Look for **unorthodox _____________** between elements and people around you  
- This is *“perceiving in a relational mode”*  
- View things and people as existing in either a _____________ (working together) or contrasting/_____________ (pushing against each other) relationship.  
...
- **Security hunting** (or _____________): always seeking safety and avoiding risk; unwilling to explore the unknown  
- **_____________**: reducing people or situations to oversimplified categories; abstracting reality  
...
1. **_____________ Creativity** — Thinking up new concepts (case studies, business competition).  

2. **_____________ Creativity** — Inventing and building tangible objects (podcast).

3. **Organizational Creativity** — New ways to structure things (pod teams, podcast workflow).  

4. **_____________ Creativity** — Innovative approaches to collaboration (mentor meetings, group work).  
...
7. **_____________ Creativity** — Acting in the moment (case discussions). 
...
- Is the process by which entrepreneurs convert opportunities (ideas) into _____________ _____________.\
- Is a combination of the vision to create a good idea and the _____________ and _____________ to remain with the concept through implementation.\
...
- **_____________** — replication with a creative twist or improvement  
...
| **_____________**| Creative replication of an existing concept                       | Walmart — department stores<br>Gateway — personal computers<br>Pizza Hut — pizza parlor |
