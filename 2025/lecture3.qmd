...
**Textbook Reading (Quiz Basis)** <br> Chapter 3.
The Entrepreneurial Mindset in Organizations: Corporate Entrepreneurship

Chapter 4.
The Global Entrepreneurial Mindset: Social Entrepreneurship
...
2.  Recording studio slots fill quickly!
    They must be recorded by **Nov 10th.**
...
-   Encourage **corporate entrepreneurship** (aka intrapreneurship).\
-   Continuously innovate to keep pace globally.

:::: fragment
::: {.callout-note icon="false" title="*Definition:* Corporate Entrepreneurship (Intrapreneurship)"}
New venture creation or strategic renewal inside an existing firm.
The infusion of entrepreneurial thinking and innovation inside larger, corporate enterprises.
:::
::::
...
::: {.column width="50%"}
![](../images/03_intrapreneurship_diagram.png) <small> [View original](https://courses.lumenlearning.com/suny-osintrobus/chapter/understanding-the-business-environment/) </small>
:::
:::::
...
1.  **Set clear innovation goals.** What steps does the employee need to take so that innovation goals are achieved?
2.  **Create a system of feedback and positive reinforcement.** How can risk-taking be encouraged within the company?\
3.  **Emphasize individual responsibility.** Key pillars: confidence, trust, accountability
4.  **Provide rewards for innovative ideas.** How can employees be incentivized to put their innovative talents to use?
5.  **Don’t punish failure.** How can the company embed failure into the innovation model?

:::: fragment
::: {.callout-note icon="false" title="*Definition:* Corporate Innovation"}
...
1.  **Set clear innovation goals.**\
    ...
    What smaller steps will get you there?
    (planning, interviewing, editing)
...
B.
Receiving feedback and positive reinforcement.\
C.
Being rewarded for innovative ideas.\
D.
Having freedom to work independently.\
E.
Having guardrails to fail safely.\

## How to Determine if Your Organization Supports Innovation
...
## Chobani’s Incubator Program for New Food Startups {data-background-color="lightblue"}
...
::: {.column width="20%"}
![](../images/03_chobani_logo.png){fig-align="right"}
:::
:::::
...
-   Example of a large food company creating an environment that **encourages entrepreneurial thinking**. 

:::: fragment
::: {.callout-note icon="false" title="*Definition:* Incubator"}
...
## Corporate Entrepreneurship Terms: <br> (1) Corporate Venturing vs. (2) Strategic Entrepreneurship
...
:::: fragment
::: {.callout-note icon="false" title="*Definition:* Corporate Venturing"}
...
:::: fragment
::: {.callout-note icon="false" title="*Definition:* Strategic Entrepreneurship"}
...
<small> *Note:* These examples are **selected from Table 3.2 in Kuratko (2024)**.
See the textbook for the complete list.</small>
...
3.  Structure for an entrepreneurial climate\
4.  Prepare individual managers for corporate innovation\
5.  Develop venture teams\

:::: fragment
::: {.callout-note icon="false" title="*Definition:* Corporate Entrepreneurship Strategy"}
...
# Part 2 <br> Social Entrepreneurship

## Setting the Stage {data-background-color="lightblue"}
...
:::: fragment
::: {.callout-note icon="false" title="*Definition:* Social Entrepreneurship"}
...
:::: fragment
::: {.callout-note icon="false" title="*Definition:* Social Entrepreneur"}
