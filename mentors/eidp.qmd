...
- If you're working on resourcefulness or creativity, you’ll stretch those muscles through problem-solving during the business case design.
...
- If your characteristic is initiative, you might push yourself to take the lead in your team’s business pitch development.

- If your focus is adaptability, you’ll strengthen that by navigating challenges during the weekly case study discussions.
...
| Persistent Problem Solving  | Tackles tough problems with a methodical, realistic approach; doesn’t quit easily. | Breaks down a messy or ambiguous case dilemma into solvable components. | Iterates on a business model that wasn’t working and comes back stronger. | Adapts when an interview doesn't go as planned (e.g., awkward question, off-topic guest). |
