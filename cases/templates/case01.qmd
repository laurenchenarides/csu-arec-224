...
## Activity 2: Evidence Buckets {data-background-color="lightblue"} 

**In groups of 3 (3 minutes):**

- Review each piece of evidence
- Determine how you would classify each piece of evidence
    - How would you "bucket" them? 
...
## Activity 3: Pick Criteria {data-background-color="lightblue"} 
...
To facilitate this, each group will "role play".
...
## Activity 4: Make an Informed Decision {data-background-color="lightblue"} 
