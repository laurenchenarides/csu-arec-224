...
subtitle: Fishbowl Discussion Guide
format:
  revealjs:
    theme: simple
    slideNumber: true
...
## [Question 1] {data-background-color="lightblue"}
*Facilitator Tip:* [Describe what to listen for, follow-up prompts, and links to course concepts]

## [Question 2] {data-background-color="lightblue"}
*Facilitator Tip:* [Describe what to listen for, follow-up prompts, and links to course concepts]

## [Question 3] {data-background-color="lightblue"}
*Facilitator Tip:* [Describe what to listen for, follow-up prompts, and links to course concepts]
