...
- [Case Analysis Worksheet](Case-Analysis-Checklist.pdf) - You will submit a completed version of this form the day before your assigned case via **Canvas**.
- [Fishbowl Discussion Template](templates/fishbowl-template.qmd) - Use this template to prepare slides or visuals to help lead the in-class discussion.
...
You’ll submit your feedback via **Canvas** using the [Observer Feedback Form](templates/observer-form.qmd).
